const strings = {
  ...
  promoMeeting: {
    ...
    description: "meeting.corifeus.com сайтында европалык бизнес үчүн түзүлгөн толук жолугушуу иш агымы — 21 тилде жандуу котормо, AI кыскача баяндамалары, тапшырмалар, чечимдер, катышуучулар жана негизги цитаталар автоматтык түрдө түзүлөт. Ыңгайлаштырылган сөздүк, издөөгө боло турган жолугушуулар китепканасы, бөлүшүүгө болгон окуу гана шилтемелери, бир чыкылдатуу менен email кыскача. EU биллинги — Stripe Tax, VAT талаптарына ылайык, EUR баалары (Solo €19.99 / Pro €39.99 / Business €99.99 айына, милдеттүү байлануу жок). Демейки боюнча GDPR талаптарына ылайык — көзөмөл cookie файлдары жок, шифрленген сактоо.",
    disclaimer: "Бул промо демо сайтта гана көрсөтүлөт жана Docker, Electron же web app жайгаштырууларында көрүнбөйт.",
    toastMessage: "Meet Assistant SaaS'ти meeting.corifeus.com сайтында сынап көрүңүз — 21 тилде жандуу котормо, AI кыскача баяндамалары, тапшырмалар. 1 мүнөт акысыз, катталуу жок, GDPR талаптарына ылайык.",
    visit: "meeting.corifeus.com сайтына өтүңүз",
  }
};
