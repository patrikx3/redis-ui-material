const strings = {
  ...
  confirm: {
    ...
    deleteArrayIndex: "Jeste li sigurni da želite izbrisati ovaj element polja?",
  ...
  label: {
      ...
      groups: {
        ...
        dataTypes: {
          ...
          prompts: [
            ...
            "rangiraj stavke prema broju skupova u kojima se pojavljuju (ZUNION AGGREGATE COUNT)"
          ]
        },
        modules: {
          name: "Moduli",
        ...
        json: {
          ...
          prompts: [
            ...
            "spremi JSON polje decimalnih brojeva smanjene preciznosti (FPHA BF16)"
          ]
        },
        search: {
          name: "RediSearch",
        ...
        array: {
          ...
          description: "Dostupno kada se otkrije Redis 8.8+ (izvorni tip ARRAY).",
          prompts: [
            "stvori polje s nekoliko vrijednosti",
            "postavi vrijednost na indeksu 5 mog polja",
            "dohvati vrijednost na određenom indeksu",
            "ispiši sve elemente polja pomoću ARSCAN",
            "izbriši element na indeksu",
            "koliko elemenata ima moje polje?"
          ]
        },
        redis8: {
          ...
          prompts: [
            ...
            "ograniči stopu za ključ pomoću prozorskog brojača (INCREX)",
    ...
    redisArrayIndexInfo: "Ostavite prazno za dodavanje na sljedeći indeks ili unesite određeni indeks (praznine su dopuštene — polja mogu biti rijetka).",
    console: "Konzola",
  ...
  page: {
    ...
    key: {
      ...
      vectorset: {
        ...
        similaritySearch: "Pretraživanje sličnosti",
        ...
        addedSuccessfully: "Stavka uspješno dodana",
        deletedSuccessfully: "Stavka uspješno obrisana",
        removedSuccessfully: "Stavka uspješno obrisana",
        attributes: "Atributi",
  ...
  promoMeeting: {
    ...
    description: "Potpuni tijek rada za sastanke izrađen za europske tvrtke na meeting.corifeus.com — prijevod uživo na 21 jezik, AI sažeci, zadaci, odluke, sudionici i ključni citati automatski se generiraju. Prilagođeni rječnik, pretraživa biblioteka sastanaka, djeljive poveznice samo za čitanje, e-mail sažetak jednim klikom. EU naplata — Stripe Tax, usklađeno s VAT, EUR cijene (Solo €19.99 / Pro €39.99 / Business €99.99 mjesečno, bez obveze). Usklađeno s GDPR prema zadanim postavkama — bez kolačića za praćenje, šifrirana pohrana.",
    disclaimer: "Ova se promocija prikazuje samo na demo web-mjestu i neće se pojaviti u Docker, Electron ili implementacijama web-aplikacija.",
    toastMessage: "Isprobajte Meet Assistant SaaS na meeting.corifeus.com — prijevod uživo na 21 jezik, AI sažeci, zadaci. 1 minuta besplatno, bez registracije, usklađeno s GDPR.",
    visit: "Posjetite meeting.corifeus.com",
  }
};
