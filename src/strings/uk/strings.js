const strings = {
  ...
  promoMeeting: {
    ...
    description: "Повний робочий процес зустрічей для європейського бізнесу на meeting.corifeus.com — живий переклад 21 мовою, AI-підсумки, завдання, рішення, учасники та ключові цитати створюються автоматично. Власний словник, бібліотека зустрічей із пошуком, посилання лише для читання, якими можна ділитися, e-mail підсумок в один клік. Білінг EU — Stripe Tax, відповідність VAT, ціни EUR (Solo €19.99 / Pro €39.99 / Business €99.99 на місяць, без прив'язки). За замовчуванням відповідає GDPR — без cookie для відстеження, зашифроване зберігання.",
    disclaimer: "Це промо показується лише на demo-сайті й не з’являється в розгортаннях Docker, Electron або вебзастосунку.",
    toastMessage: "Спробуйте Meet Assistant SaaS на meeting.corifeus.com — живий переклад 21 мовою, AI-підсумки, завдання. 1 хвилина безкоштовно, без реєстрації, відповідає GDPR.",
    visit: "Відвідати meeting.corifeus.com",
  }
};
