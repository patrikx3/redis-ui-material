const strings = {
  ...
  confirm: {
    ...
    deleteArrayIndex: "Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτό το στοιχείο πίνακα;",
  ...
  label: {
      ...
      groups: {
        ...
        dataTypes: {
          ...
          prompts: [
            ...
            "κατάταξε στοιχεία με βάση σε πόσα σύνολα εμφανίζονται (ZUNION AGGREGATE COUNT)"
          ]
        },
        modules: {
          name: "Ενότητες",
        ...
        json: {
          ...
          prompts: [
            ...
            "αποθήκευσε JSON πίνακα από floats με μειωμένη ακρίβεια (FPHA BF16)"
          ]
        },
        search: {
          name: "RediSearch",
        ...
        timeseries: {
          ...
          prompts: [
            ...
            "πάρε min, max, first και last ανά bucket με ένα TS.RANGE (candlestick)"
          ]
        },
        bloom: {
        ...
        array: {
          name: "Πίνακας (Redis 8.8+)",
          description: "Διαθέσιμο όταν εντοπιστεί Redis 8.8+ (εγγενής τύπος ARRAY).",
          prompts: [
            "δημιούργησε πίνακα με λίγες τιμές",
            "όρισε την τιμή στο index 5 του πίνακά μου",
            "πάρε την τιμή σε συγκεκριμένο index",
            "λίστα όλων των στοιχείων πίνακα με ARSCAN",
            "διέγραψε το στοιχείο σε ένα index",
            "πόσα στοιχεία έχει ο πίνακάς μου;"
          ]
        },
        redis8: {
          ...
          prompts: [
            ...
            "εφάρμοσε rate-limit σε κλειδί με μετρητή παραθύρου (INCREX)",
            "κάνε negative-ack σε εκκρεμές μήνυμα stream προς dead-letter (XNACK)"
          ]
        },
        scripting: {
          name: "Σενάριο",
    ...
    redisArrayIndexInfo: "Αφήστε το κενό για προσθήκη στο επόμενο ευρετήριο ή ορίστε συγκεκριμένο ευρετήριο (επιτρέπονται κενά — οι πίνακες μπορεί να είναι αραιοί).",
    console: "Κονσόλα",
  ...
  status: {
    ...
    deletedArrayIndex: "Το στοιχείο πίνακα διαγράφηκε",
  ...
  page: {
    ...
    key: {
      ...
      vectorset: {
        ...
        similaritySearch: "Αναζήτηση ομοιότητας",
        searchByElement: "Αναζήτηση κατά στοιχείο",
        searchByVector: "Αναζήτηση κατά διάνυσμα",
        byElement: "Αναζήτηση κατά στοιχείο",
        byVector: "Αναζήτηση κατά διάνυσμα",
        vectorValues: "Τιμές διανύσματος",
        elementName: "Όνομα στοιχείου",
        ...
        addedSuccessfully: "Το στοιχείο προστέθηκε επιτυχώς",
        deletedSuccessfully: "Το στοιχείο διαγράφηκε επιτυχώς",
        removedSuccessfully: "Το στοιχείο διαγράφηκε επιτυχώς",
  ...
  promoMeeting: {
    ...
    description: "Πλήρης ροή εργασίας συναντήσεων για ευρωπαϊκές επιχειρήσεις στο meeting.corifeus.com — ζωντανή μετάφραση σε 21 γλώσσες, περιλήψεις AI, ενέργειες, αποφάσεις, συμμετέχοντες και βασικά αποσπάσματα δημιουργούνται αυτόματα. Προσαρμοσμένο λεξιλόγιο, αναζητήσιμη βιβλιοθήκη συναντήσεων, κοινοποιήσιμοι σύνδεσμοι μόνο για ανάγνωση, σύνοψη email με ένα κλικ. Τιμολόγηση EU — Stripe Tax, συμβατό με VAT, τιμές EUR (Solo €19.99 / Pro €39.99 / Business €99.99 ανά μήνα, χωρίς δέσμευση). Συμβατό με GDPR από προεπιλογή — χωρίς cookies παρακολούθησης, κρυπτογραφημένη αποθήκευση.",
    disclaimer: "Αυτή η προώθηση εμφανίζεται μόνο στον ιστότοπο επίδειξης και δεν θα εμφανίζεται σε Docker, Electron ή αναπτύξεις εφαρμογών ιστού.",
    toastMessage: "Δοκιμάστε το Meet Assistant SaaS στο meeting.corifeus.com — ζωντανή μετάφραση σε 21 γλώσσες, περιλήψεις AI, ενέργειες. 1 λεπτό δωρεάν, χωρίς εγγραφή, συμβατό με GDPR.",
    visit: "Επισκεφθείτε το meeting.corifeus.com",
  }
};
