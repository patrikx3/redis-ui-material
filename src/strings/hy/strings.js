const strings = {
  ...
  confirm: {
    ...
    deleteArrayIndex: "Վստա՞հ եք, որ ուզում եք ջնջել այս զանգվածի տարրը:",
  ...
  label: {
      ...
      groups: {
        ...
        dataTypes: {
          ...
          prompts: [
            ...
            "դասավորիր տարրերը ըստ այն բանի, թե քանի set-ում են դրանք հայտնվում (ZUNION AGGREGATE COUNT)"
          ]
        },
        modules: {
          name: "Մոդուլներ",
        ...
        json: {
          ...
          prompts: [
            ...
            "պահիր floats-ի JSON զանգված նվազեցված ճշտությամբ (FPHA BF16)"
          ]
        },
        search: {
          name: "RediSearch",
        ...
        timeseries: {
          ...
          prompts: [
            ...
            "ստացիր min, max, first և last յուրաքանչյուր bucket-ի համար մեկ TS.RANGE-ով (candlestick)"
          ]
        },
        bloom: {
        ...
        array: {
          name: "Զանգված (Redis 8.8+)",
          description: "Հասանելի է, երբ Redis 8.8+ հայտնաբերված է (բնական ARRAY տեսակը):",
          prompts: [
            "ստեղծիր զանգված մի քանի արժեքներով",
            "սահմանիր արժեքը իմ զանգվածի 5-րդ ինդեքսում",
            "ստացիր արժեքը կոնկրետ ինդեքսում",
            "ցուցակագրիր զանգվածի բոլոր տարրերը ARSCAN-ով",
            "ջնջիր տարրը ինդեքսում",
            "քանի՞ տարր ունի իմ զանգվածը"
          ]
        },
        redis8: {
          ...
          prompts: [
            ...
            "սահմանափակիր բանալու հաճախականությունը պատուհանի հաշվիչով (INCREX)",
            "կատարիր negative-ack սպասող stream հաղորդագրության համար դեպի dead-letter (XNACK)"
          ]
        },
        scripting: {
          name: "Սցենարավորում",
    ...
    redisArrayIndexInfo: "Դատարկ թողեք՝ հաջորդ ինդեքսում ավելացնելու համար, կամ նշեք կոնկրետ ինդեքս (բացերը թույլատրված են — զանգվածները կարող են նոսր լինել):",
    console: "Վահանակ",
  ...
  status: {
    ...
    deletedArrayIndex: "Զանգվածի տարրը ջնջվեց",
  ...
  page: {
    ...
    key: {
      ...
      vectorset: {
        ...
        similaritySearch: "Նմանության որոնում",
        searchByElement: "Որոնել ըստ տարրի",
        searchByVector: "Որոնել ըստ վեկտորի",
        byElement: "Որոնել ըստ տարրի",
        byVector: "Որոնել ըստ վեկտորի",
        vectorValues: "Վեկտորի արժեքներ",
        elementName: "Տարրի անուն",
        ...
        addedSuccessfully: "Տարրը հաջողությամբ ավելացվեց",
        deletedSuccessfully: "Տարրը հաջողությամբ ջնջվեց",
        removedSuccessfully: "Տարրը հաջողությամբ ջնջվեց",
  ...
  promoMeeting: {
    ...
    description: "meeting.corifeus.com-ում եվրոպական բիզնեսների համար ստեղծված հանդիպումների ամբողջական աշխատանքային հոսք — կենդանի թարգմանություն 21 լեզվով, AI ամփոփումներ, գործողությունների կետեր, որոշումներ, մասնակիցներ և հիմնական մեջբերումներ ստեղծվում են ավտոմատ։ Հարմարեցվող բառապաշար, որոնելի հանդիպումների գրադարան, կիսվող միայն ընթերցման հղումներ, մեկ սեղմումով էլ. փոստի ամփոփում։ EU հաշվարկ — Stripe Tax, VAT-ին համապատասխան, EUR գներ (Solo €19.99 / Pro €39.99 / Business €99.99 ամսական, առանց պարտադիր կապի)։ Լռելյայն GDPR-ին համապատասխան — առանց հետևող cookie-ների, կոդավորված պահպանում։",
    disclaimer: "Այս խթանումը ցուցադրվում է միայն ցուցադրական կայքում և չի հայտնվի Docker, Electron կամ վեբ հավելվածների տեղակայման ժամանակ:",
    toastMessage: "Փորձեք Meet Assistant SaaS-ը meeting.corifeus.com-ում — կենդանի թարգմանություն 21 լեզվով, AI ամփոփումներ, գործողությունների կետեր։ 1 րոպե անվճար, առանց գրանցման, GDPR-ին համապատասխան։",
    visit: "Այցելել meeting.corifeus.com",
  }
};
