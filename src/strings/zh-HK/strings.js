const strings = {
  ...
  label: {
    ...
    licenseActiveDevices: "有源设备",
    licenseActiveDevicesInfo: "如果不再使用某个设备，其座位将在 75 分钟后自动释放。",
    licenseCustomerEmail: "客户邮箱",
    licenseFeatures: "特點",
    licenseFeaturesEmpty: "没有额外的功能",
    licenseFeatureReadonlyMode: "只读连接模式",
    licenseFeatureReadonlyConnectionsFlag: "只读连接 (--readonly-connections/-r)",
    licenseFeatureSsh: "SSH 隧道",
    licenseFeatureCluster: "Cluster 连接",
    licenseFeatureSentinel: "Sentinel 連接",
    licenseFeatureReJSON: "ReJSON（JSON 数据类型）",
    keysSort: {
      on: "键排序开启",
      off: "鑰匙分類"
    },
    ...
    proSshOnly: "SSH 适用于专业版或企业版。",
    proReadonlyOnly: "只读连接模式在专业版或企业版中可用。",
    enterpriseClusterSentinelOnly: "Cluster 和 Sentinel 仅在企业版中可用。",
    theme: {
      light: "光",
      dark: "黑暗企业",
      darkNeu: "黑暗",
