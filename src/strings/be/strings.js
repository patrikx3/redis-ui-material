const strings = {
  ...
  confirm: {
    ...
    deleteArrayIndex: "Вы ўпэўнены, што хочаце выдаліць гэты элемент масіву?",
  ...
  label: {
      ...
      groups: {
        ...
        dataTypes: {
          ...
          prompts: [
            ...
            "адсартуй элементы па колькасці набораў, у якіх яны сустракаюцца (ZUNION AGGREGATE COUNT)"
          ]
        },
        modules: {
          name: "Модулі",
        ...
        json: {
          ...
          prompts: [
            ...
            "захавай JSON-масіў лікаў з плаваючай кропкай са зніжанай дакладнасцю (FPHA BF16)"
          ]
        },
        search: {
          name: "RediSearch",
        ...
        timeseries: {
          ...
          prompts: [
            ...
            "атрымай min, max, first і last для кожнага bucket адным TS.RANGE (candlestick)"
          ]
        },
        bloom: {
        ...
        array: {
          name: "Масіў (Redis 8.8+)",
          description: "Даступна пры выяўленні Redis 8.8+ (родны тып ARRAY).",
          prompts: [
            "ствары масіў з некалькімі значэннямі",
            "задай значэнне ў індэксе 5 майго масіву",
            "атрымай значэнне па канкрэтным індэксе",
            "пералічы ўсе элементы масіву з ARSCAN",
            "выдалі элемент па індэксе",
            "колькі элементаў мае мой масіў?"
          ]
        },
        redis8: {
          ...
          prompts: [
            ...
            "абмяжуй частату для ключа праз аконны лічыльнік (INCREX)",
            "зрабі negative-ack чаканаму паведамленню stream у dead-letter (XNACK)"
          ]
        },
        scripting: {
          name: "Сцэнарый",
    ...
    redisArrayIndexInfo: "Пакіньце пустым, каб дадаць у наступны індэкс, або задайце канкрэтны індэкс (прагалы дазволены — масівы могуць быць разрэджанымі).",
    console: "Кансоль",
  ...
  status: {
    ...
    deletedArrayIndex: "Элемент масіву выдалены",
  ...
  page: {
    ...
    key: {
      ...
      vectorset: {
        ...
        similaritySearch: "Пошук падабенства",
        searchByElement: "Пошук па элеменце",
        searchByVector: "Пошук па вектары",
        byElement: "Пошук па элеменце",
        byVector: "Пошук па вектары",
        vectorValues: "Значэнні вектара",
        elementName: "Назва элемента",
        searchTerm: "Пошукавы тэрмін",
        element: "Элемент",
        score: "Бал",
        count: "Колькасць",
        ...
        addedSuccessfully: "Элемент паспяхова дададзены",
        deletedSuccessfully: "Элемент паспяхова выдалены",
        removedSuccessfully: "Элемент паспяхова выдалены",
        attributes: "Атрыбуты",
  ...
  promoMeeting: {
    ...
    description: "Поўны працоўны працэс для сустрэч, створаны для еўрапейскага бізнесу на meeting.corifeus.com — жывы пераклад на 21 мову, AI-зводкі, задачы, рашэнні, удзельнікі і ключавыя цытаты ствараюцца аўтаматычна. Уласны слоўнік, пошукавая бібліятэка сустрэч, спасылкі толькі для чытання, якімі можна дзяліцца, зводка па email у адзін клік. Білінг EU — Stripe Tax, адпаведнасць VAT, цэны ў EUR (Solo €19.99 / Pro €39.99 / Business €99.99 у месяц, без прывязкі). Па змаўчанні адпавядае GDPR — без cookie для адсочвання, шыфраванае захоўванне.",
    disclaimer: "Гэтая акцыя паказваецца толькі на дэма-сайце і не будзе з'яўляцца ў Docker, Electron або разгортванні вэб-праграм.",
    toastMessage: "Паспрабуйце Meet Assistant SaaS на meeting.corifeus.com — жывы пераклад на 21 мову, AI-зводкі, задачы. 1 хвіліна бясплатна, без рэгістрацыі, адпавядае GDPR.",
    visit: "Наведаць meeting.corifeus.com",
  }
};
