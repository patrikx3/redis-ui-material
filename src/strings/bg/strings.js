const strings = {
  ...
  confirm: {
    ...
    deleteArrayIndex: "Сигурни ли сте, че искате да изтриете този елемент от масива?",
  ...
  label: {
      ...
      groups: {
        ...
        dataTypes: {
          ...
          prompts: [
            ...
            "подреди елементите по броя множества, в които се срещат (ZUNION AGGREGATE COUNT)"
          ]
        },
        modules: {
          name: "Модули",
        ...
        json: {
          ...
          prompts: [
            ...
            "запази JSON масив от числа с плаваща запетая с намалена точност (FPHA BF16)"
          ]
        },
        search: {
          name: "RediSearch",
        ...
        timeseries: {
          ...
          prompts: [
            ...
            "вземи min, max, first и last за всеки bucket с един TS.RANGE (candlestick)"
          ]
        },
        bloom: {
        ...
        array: {
          ...
          description: "Налично, когато се открие Redis 8.8+ (роден тип ARRAY).",
          prompts: [
            "създай масив с няколко стойности",
            "задай стойността на индекс 5 в моя масив",
            "вземи стойността на конкретен индекс",
            "изброй всички елементи на масив с ARSCAN",
            "изтрий елемента на индекс",
            "колко елемента има моят масив?"
          ]
        },
        redis8: {
          ...
          prompts: [
            ...
            "ограничи честотата за ключ с прозоречен брояч (INCREX)",
            "направи negative-ack на чакащо stream съобщение към dead-letter (XNACK)"
          ]
        },
        scripting: {
          name: "Скриптиране",
    ...
    redisArrayIndexInfo: "Оставете празно за добавяне на следващия индекс или задайте конкретен индекс (пропуските са позволени — масивите може да са разредени).",
    console: "Конзола",
  ...
  status: {
    ...
    deletedArrayIndex: "Елементът от масива е изтрит",
  ...
  page: {
    ...
    key: {
      ...
      vectorset: {
        ...
        similaritySearch: "Търсене по сходство",
        searchByElement: "Търсене по елемент",
        searchByVector: "Търсене по вектор",
        byElement: "Търсене по елемент",
        byVector: "Търсене по вектор",
        ...
        addedSuccessfully: "Елементът е добавен успешно",
        deletedSuccessfully: "Елементът е изтрит успешно",
        removedSuccessfully: "Елементът е изтрит успешно",
        attributes: "Атрибути",
  ...
  promoMeeting: {
    ...
    description: "Пълен работен процес за срещи, създаден за европейски бизнеси в meeting.corifeus.com — превод на живо на 21 езика, AI резюмета, задачи, решения, участници и ключови цитати се генерират автоматично. Персонализиран речник, търсима библиотека със срещи, споделими връзки само за четене, имейл резюме с един клик. EU фактуриране — Stripe Tax, съответствие с VAT, цени в EUR (Solo €19.99 / Pro €39.99 / Business €99.99 на месец, без обвързване). GDPR-съвместим по подразбиране — без проследяващи cookies, криптирано съхранение.",
    disclaimer: "Тази промоция се показва само на демонстрационния сайт и няма да се показва в Docker, Electron или внедрявания на уеб приложения.",
    toastMessage: "Опитайте Meet Assistant SaaS на meeting.corifeus.com — превод на живо на 21 езика, AI резюмета, задачи. 1 минута безплатно, без регистрация, GDPR-съвместим.",
    visit: "Посетете meeting.corifeus.com",
  }
};
