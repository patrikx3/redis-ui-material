const strings = {
  error: {
    ...
    aiPromptTooLong: "La solicitud de AI es demasiado larga (máximo 4096 caracteres)",
  },
  title: {
    donate: "Donar",
  ...
  confirm: {
    ...
    deleteArrayIndex: "¿Seguro que desea eliminar este elemento del array?",
  ...
  label: {
      ...
      groups: {
        ...
        dataTypes: {
          ...
          prompts: [
            ...
            "clasifica los elementos por cuántos conjuntos contienen cada uno (ZUNION AGGREGATE COUNT)"
          ]
        },
        modules: {
          name: "Módulos",
        ...
        json: {
          ...
          prompts: [
            ...
            "guarda un array JSON de floats con precisión reducida (FPHA BF16)"
          ]
        },
        search: {
          name: "RediSearch",
        ...
        timeseries: {
          ...
          prompts: [
            ...
            "obtén min, max, first y last por bucket en un solo TS.RANGE (candlestick)"
          ]
        },
        bloom: {
        ...
        array: {
          ...
          description: "Disponible cuando se detecta Redis 8.8+ (tipo ARRAY nativo).",
          prompts: [
            "crea un array con algunos valores",
            "establece el valor en el índice 5 de mi array",
            "obtén el valor de un índice específico",
            "lista todos los elementos de un array con ARSCAN",
        ...
        redis8: {
          ...
          prompts: [
            ...
            "limita la tasa de una clave con un contador de ventana (INCREX)",
            "haz negative-ack de un mensaje stream pendiente hacia dead-letter (XNACK)"
          ]
        },
        scripting: {
    ...
    aclAuthHint: "Utilice el nombre de usuario y la contraseña de Redis ACL para autenticarse. Déjelo vacío para el usuario predeterminado sin contraseña.",
    ...
    redisArrayIndexInfo: "Déjelo vacío para anexar en el siguiente índice, o introduzca un índice explícito (se permiten huecos — los arrays pueden ser dispersos).",
    console: "Consola",
  ...
  status: {
    ...
    socketError: "Error de conexión",
    deletedHashKey: "Clave hash eliminada",
    deletedArrayIndex: "Elemento de array eliminado",
    deletedSetMember: "Miembro del conjunto eliminado",
    deletedListElement: "Elemento de lista eliminado",
    deletedZSetMember: "Miembro del conjunto ordenado eliminado",
    deletedStreamTimestamp: "Entrada de flujo eliminada",
  },
  code: {
  ...
  form: {
    ...
    key: {
      ...
      field: {
        ...
        item: "Elemento",
        vectorValues: "Valores del vector (separados por comas)",
      ...
      error: {
        ...
        errorRate: "La tasa de error debe estar entre 0 y 1 (ej. 0.01)",
        capacity: "La capacidad debe ser un entero positivo",
        topk: "Top K debe ser un entero positivo",
        width: "El ancho debe ser un entero positivo",
        depth: "La profundidad debe ser un entero positivo",
        item: "El elemento es obligatorio"
      }
    },
    main: {
      label: {
  ...
  page: {
    search: {
      ...
      hybridMode: "Búsqueda híbrida (FT.HYBRID)",
      vectorField: "Campo vectorial",
      vectorValues: "Valores vectoriales",
    },
    monitor: {
      title: "Monitoreo",
      memory: "Memoria",
      ...
      networkIo: "Red I/O",
      slowLog: "Log lento",
      noSlowQueries: "No se registraron consultas lentas.",
      confirmSlowLogReset: "¿Está seguro de que desea restablecer el registro lento?",
      slowLogResetDone: "Se restableció el registro lento.",
      totalCommands: "Total",
      expired: "Expirados",
      evicted: "Desalojados",
      ...
      slotStats: "Estadísticas de slots del clúster",
      ...
      keyspace: "Espacio clave Redis",
      keys: "Claves Redis",
      expires: "Vence",
      noKeyspace: "Sin claves",
      persistence: "Persistencia de datos",
      rdbLastSave: "RDB último guardado",
      rdbStatus: "Estado de la BDR",
      rdbChanges: "Cambios desde el último guardado",
      aofEnabled: "AOF habilitado",
      aofSize: "Tamaño AOF",
      replication: "Replicación Redis",
      role: "Rol de replicación",
      replicas: "Réplicas conectadas",
      masterHost: "Anfitrión principal",
      linkStatus: "Estado del enlace de replicación",
      cpu: "Uso de CPU",
      cpuSys: "Sistema",
      cpuUser: "Usuario",
      modules: "Módulos Redis cargados",
      noModules: "No hay módulos Redis cargados",
      clusterSlotMap: "Mapa de ranuras del clúster de Redis",
      slotRange: "Rango de ranuras del grupo",
      totalSlots: "Espacios totales del clúster",
      noClusterData: "No hay datos del clúster de Redis disponibles.",
    },
    analysis: {
      ...
      doctorNoData: "Haga clic en Actualizar para ejecutar los diagnósticos de Memory Doctor.",
    },
    acl: {
      title: "Usuarios de ACL",
      ...
      commands: "Comandos",
      commandsHint: "por ejemplo, +@all or +@read -@dangerous",
      keys: "Patrones clave de Redis",
      keysHint: "por ejemplo, ~* or ~user:*",
      channels: "Canales Pub/Sub",
      channelsHint: "por ejemplo, &* or &notifications:*",
      password: "Contraseña",
      noPassword: "Sin contraseña (nopass)",
      passwordHint: "Déjelo vacío para mantener la contraseña actual",
      currentUser: "Actual",
      createUser: "Crear usuario",
      editUser: "Editar usuario",
      deleteUser: "Eliminar",
      confirmDelete: "¿Está seguro de que desea eliminar el usuario ACL?",
      userDeleted: "El usuario ACL fue eliminado.",
      userSaved: "Se guardó el usuario ACL.",
      cannotDeleteDefault: "No se puede eliminar el usuario predeterminado.",
      cannotDeleteSelf: "No se puede eliminar el usuario actualmente conectado.",
      noUsers: "ACL requiere Redis 6.0+.",
      groupCommon: "General",
      groupDataTypes: "Tipos de datos",
      groupOperations: "Operaciones",
      rules: "Reglas",
      rulesHint: "Tokens separados por espacios (por ejemplo on >password +@all ~* &*)",
      defaultUserWarning: "Precaución: Modificar el usuario predeterminado puede bloquear todas las conexiones. Si esto sucede, deberá reiniciar Redis o usar redis-cli para restaurar el acceso.",
    },
    overview: {
    ...
    key: {
      ...
      probabilistic: {
        ...
        topkList: "Elementos principales",
        topkCount: "Cantidad",
        queryCount: "Cantidad de consultas",
        queryResult: "Resultado de consulta",
        addedSuccessfully: "Elemento agregado exitosamente",
        deletedSuccessfully: "Elemento eliminado exitosamente",
        quantile: "Cuantil",
        quantileResult: "Resultado",
        noItems: "No hay elementos para mostrar",
        resetConfirm: "Restablecer todos los datos en este T-Digest?",
      },
      vectorset: {
        info: "Información",
        elements: "Elementos",
        similarity: "Búsqueda de similitud",
        similaritySearch: "Búsqueda de similitud",
        searchByElement: "Buscar por elemento",
        searchByVector: "Buscar por vector",
        byElement: "Buscar por elemento",
        byVector: "Buscar por vector",
        vectorValues: "Valores del vector",
        ...
        addedSuccessfully: "Elemento agregado exitosamente",
        deletedSuccessfully: "Elemento eliminado exitosamente",
        removedSuccessfully: "Elemento eliminado exitosamente",
        attributes: "Atributos",
        noAttributes: "Sin atributos",
        dimensions: "Dimensiones",
        removeConfirm: "¿Eliminar este elemento del VectorSet?",
  ...
  promoMeeting: {
    ...
    description: "Flujo completo de reuniones creado para empresas europeas en meeting.corifeus.com — traducción en directo en 21 idiomas, resúmenes AI, acciones, decisiones, asistentes y citas clave generados automáticamente. Vocabulario personalizado, biblioteca de reuniones con búsqueda, enlaces compartibles de solo lectura, resumen por email con un clic. Facturación EU — Stripe Tax, compatible con VAT, precios en EUR (Solo €19.99 / Pro €39.99 / Business €99.99 al mes, sin permanencia). Compatible con GDPR por defecto — sin cookies de seguimiento, almacenamiento cifrado.",
    disclaimer: "Esta promoción solo se muestra en el sitio de demostración y no aparecerá en Docker, Electron ni en implementaciones de aplicaciones web.",
    toastMessage: "Prueba Meet Assistant SaaS en meeting.corifeus.com — traducción en directo en 21 idiomas, resúmenes AI, acciones. 1 minuto gratis, sin registro, compatible con GDPR.",
    visit: "Visita meeting.corifeus.com",
  }
};
