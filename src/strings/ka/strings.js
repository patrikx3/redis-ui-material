const strings = {
  ...
  promoMeeting: {
    ...
    description: "meeting.corifeus.com-ზე ევროპული ბიზნესებისთვის შექმნილი შეხვედრების სრული სამუშაო პროცესი — ცოცხალი თარგმანი 21 ენაზე, AI შეჯამებები, სამოქმედო პუნქტები, გადაწყვეტილებები, მონაწილეები და მთავარი ციტატები ავტომატურად იქმნება. მორგებული ლექსიკა, საძიებო შეხვედრების ბიბლიოთეკა, გასაზიარებელი მხოლოდ წაკითხვის ბმულები, ელფოსტის შეჯამება ერთი დაწკაპებით. EU ბილინგი — Stripe Tax, VAT-თან შესაბამისი, EUR ფასები (Solo €19.99 / Pro €39.99 / Business €99.99 თვეში, მიბმის გარეშე). ნაგულისხმევად GDPR-თან შესაბამისი — თვალთვალის cookie-ების გარეშე, დაშიფრული შენახვა.",
    disclaimer: "Ეს პრომოაქცია ნაჩვენებია მხოლოდ დემო ვებსაიტზე და არ გამოჩნდება Docker, Electron ან ვებ-აპლიკაციების განლაგებაში.",
    toastMessage: "სცადეთ Meet Assistant SaaS meeting.corifeus.com-ზე — ცოცხალი თარგმანი 21 ენაზე, AI შეჯამებები, სამოქმედო პუნქტები. 1 წუთი უფასოდ, რეგისტრაციის გარეშე, GDPR-თან შესაბამისი.",
    visit: "ეწვიეთ meeting.corifeus.com-ს",
  }
};
