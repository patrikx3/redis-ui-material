const strings = {
  ...
  promoMeeting: {
    ...
    description: "Потпуни ток рада за састанке направљен за европска предузећа на meeting.corifeus.com — превод уживо на 21 језик, AI резимеи, задаци, одлуке, учесници и кључни цитати генеришу се аутоматски. Прилагођени речник, претражива библиотека састанака, дељиве везе само за читање, e-mail резиме једним кликом. EU наплата — Stripe Tax, усклађено са VAT, EUR цене (Solo €19.99 / Pro €39.99 / Business €99.99 месечно, без везивања). Подразумевано усклађено са GDPR — без колачића за праћење, шифровано складиштење.",
    disclaimer: "Ова промоција се приказује само на demo страници и неће се појавити у Docker, Electron или веб апликацијским имплементацијама.",
    toastMessage: "Испробајте Meet Assistant SaaS на meeting.corifeus.com — превод уживо на 21 језик, AI резимеи, задаци. 1 минут бесплатно, без регистрације, усклађено са GDPR.",
    visit: "Посетите meeting.corifeus.com",
  }
};
