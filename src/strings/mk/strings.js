const strings = {
  ...
  promoMeeting: {
    ...
    description: "Целосен работен тек за состаноци создаден за европски бизниси на meeting.corifeus.com — превод во живо на 21 јазик, AI резимеа, задачи, одлуки, учесници и клучни цитати се генерираат автоматски. Прилагоден речник, пребарлива библиотека на состаноци, споделливи врски само за читање, е-пошта резиме со еден клик. EU наплата — Stripe Tax, усогласено со VAT, EUR цени (Solo €19.99 / Pro €39.99 / Business €99.99 месечно, без обврзување). Стандардно усогласено со GDPR — без колачиња за следење, шифрирано складирање.",
    disclaimer: "Оваа промоција се прикажува само на демо-страницата и нема да се појавува во распоредувања на Docker, Electron или веб-апликацијата.",
    toastMessage: "Пробајте Meet Assistant SaaS на meeting.corifeus.com — превод во живо на 21 јазик, AI резимеа, задачи. 1 минута бесплатно, без регистрација, усогласено со GDPR.",
