const strings = {
  ...
  label: {
    ...
    aclAuthHint: "Käytä Redis ACL-käyttäjätunnusta ja salasanaa todentamiseen. Jätä tyhjäksi oletuskäyttäjälle, jolla ei ole salasanaa.",
  ...
  status: {
    ...
    deletedStreamTimestamp: "Virran merkintä poistettu",
  },
  code: {
  ...
  page: {
    ...
    monitor: {
      ...
      slowLog: "Hidas loki",
      noSlowQueries: "Hitaita kyselyitä ei tallennettu.",
      confirmSlowLogReset: "Haluatko varmasti nollata hitaan lokin?",
      slowLogResetDone: "Hidas loki nollattiin.",
      ...
      serverInfo: "Palvelimen tiedot",
      os: "Käyttöjärjestelmä",
      port: "Verkkoportti",
      pid: "Prosessin tunnus",
      configFile: "Asetustiedosto",
      uptime: "Päällä",
      keyspace: "Redis avainväli",
      keys: "Redis avaimet",
      expires: "Vanhenee",
      noKeyspace: "Ei avaimia",
      persistence: "Tietojen pysyvyys",
      rdbLastSave: "RDB viimeinen tallennus",
      rdbStatus: "RDB:n tila",
      rdbChanges: "Muutokset edellisen tallennuksen jälkeen",
      aofEnabled: "AOF käytössä",
      aofSize: "AOF koko",
      replication: "Redis replikointi",
      role: "Replikointirooli",
      replicas: "Yhdistetyt jäljennökset",
      masterHost: "Ensisijainen isäntä",
      linkStatus: "Replikointilinkin tila",
      cpu: "CPU:n käyttö",
      cpuSys: "Järjestelmä",
      cpuUser: "Käyttäjä",
      modules: "Ladatut Redis-moduulit",
      noModules: "Redis-moduuleja ei ladattu",
      clusterSlotMap: "Redis-klusterin paikkakartta",
      slotRange: "Klusterin paikkavalikoima",
      totalSlots: "Klusteripaikkoja yhteensä",
      noClusterData: "Redis-klusteritietoja ei ole saatavilla.",
    },
    analysis: {
      ...
      doctorNoData: "Suorita Memory Doctor-diagnostiikka napsauttamalla Päivitä.",
    },
    acl: {
      title: "ACL-käyttäjät",
      loadUsers: "Lataa käyttäjiä",
      loading: "Ladataan...",
      username: "Käyttäjätunnus",
      status: "Tila",
      enabled: "Käytössä",
      ...
      commands: "komennot",
      commandsHint: "esim. +@all or +@read -@dangerous",
      keys: "Redis avainkuvioita",
      keysHint: "esim. ~* or ~user:*",
      channels: "Pub/Sub-kanavat",
      channelsHint: "esim. &* or &notifications:*",
      password: "Salasana",
      noPassword: "Ei salasanaa (nopass)",
      passwordHint: "Jätä tyhjäksi säilyttääksesi nykyinen salasana",
      currentUser: "Nykyinen",
      createUser: "Luo käyttäjä",
      editUser: "Muokkaa käyttäjää",
      deleteUser: "Poista",
      confirmDelete: "Haluatko varmasti poistaa ACL-käyttäjän?",
      userDeleted: "ACL-käyttäjä poistettiin.",
      userSaved: "ACL-käyttäjä tallennettu.",
      cannotDeleteDefault: "Oletuskäyttäjää ei voi poistaa.",
      cannotDeleteSelf: "Tällä hetkellä yhdistettyä käyttäjää ei voi poistaa.",
      noUsers: "ACL vaatii Redis 6.0+.",
      groupCommon: "Yleiset",
      groupDataTypes: "Tietotyypit",
      groupOperations: "Toiminnot",
      rules: "Säännöt",
